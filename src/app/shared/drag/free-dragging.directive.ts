...
export class FreeDraggingDirective implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.targetElement = document.getElementById('uploadVideo');
    this.initDrag();
  }
  ...
  initDrag(): void {
    ...
    const dragEndSub = dragEnd$.subscribe(() => {
      ...
      const targetRect = this.targetElement.getBoundingClientRect();
        ...
        // initialX = currentX;
        // initialY = currentY;
        this.element.setAttribute('PositionX',left.toString());
        this.element.setAttribute('PositionY',top.toString());
